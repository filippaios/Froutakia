...
namespace WindowsFormsApp1
{
    public partial class Form4 : Form
    {
        ...
        int count_play1 = 0, count_play2 = 0, count_play3 = 0, count_play4 = 0, count_play5 = 0;
        string username;
        ...
        {
            int froutou = random.Next(1, 8);//δημιουργία τυχαίου αριθμού
            ...
            {
                pictureBox2.ImageLocation = "κεράσι.png"; 

            }
            else if (froutou == 6)
            {
                pictureBox2.ImageLocation = "εφτά.png"; 
        ...
        private void timer3_Tick(object sender, EventArgs e)
        {
            ...
            {
                pictureBox3.ImageLocation = "κεράσι.png";

            }
            else if (froutou == 2)
            {
                pictureBox3.ImageLocation = "εφτά.png"; 
        ...
        private void timer4_Tick(object sender, EventArgs e)
        {
            ...
            {
                pictureBox4.ImageLocation = "κεράσι.png";

            }
            else if (froutou == 4)
            {
                pictureBox4.ImageLocation = "εφτά.png";
            ...
            if (timer4.Interval == 500)//στην περίπτωση που έχει μειωθεί ο χρόνος εμφάνισης των εικονών
            {
                count_play4++;//αν το count_start1 δεν είναι τρια ακόμα αύξησέ το 
                if (count_play4 == 3)//μέτρα μέχρι το τρια
                {
                    timer4.Enabled = false;//και μετά κλείσε το timer του picturebox1 
                    timer5.Interval = 500;//και μείωσε το χρόνο λειτουργίας στο επόμενο picturebox2
                    count_play4 = 0;//μηδένισε το count_start1 για όταν ξανά χρησιμοποιηθεί
                }
        ...
        private void timer5_Tick(object sender, EventArgs e)
        {
            ...
            if (froutou == 1)//αν ο τυχαίος αριθμός είναι το ένα εμφάνισε την εικόνα αστέρι
            {
                pictureBox5.ImageLocation = "καρπούζι.png";

            }
            else if (froutou == 2)
            {
                pictureBox5.ImageLocation = "βατόμουρο.png";

            }
            else if (froutou == 3)
            {
                pictureBox5.ImageLocation = "αστέρι.png";

            }
            else if (froutou == 4)
            {
                pictureBox5.ImageLocation = "κεράσι.png";

            }
            else if (froutou == 5)
            {
                pictureBox5.ImageLocation = "εφτά.png";

            }
            else if (froutou == 6)
            {
                pictureBox5.ImageLocation = "αχλάδι.png";

            }
            else if (froutou == 7)
            {
                pictureBox5.ImageLocation = "πορτοκάλι.png";

            }
            else if (froutou == 8)
            {
                pictureBox5.ImageLocation = "λεμόνι.png";
            ...
            if (timer5.Interval == 500)
            {
                ...
                if (count_play5 == 3)
                {
                    ...
                    if (pictureBox1.ImageLocation == "αστέρι.png" & pictureBox2.ImageLocation == "αστέρι.png" & pictureBox3.ImageLocation == "αστέρι.png" & pictureBox4.ImageLocation == "αστέρι.png" & pictureBox5.ImageLocation == "αστέρι.png")
                    {
                    ...
                    else if (pictureBox1.ImageLocation == "καρπούζι.png" & pictureBox2.ImageLocation == "καρπούζι.png" & pictureBox3.ImageLocation == "καρπούζι.png" & pictureBox4.ImageLocation == "καρπούζι.png" & pictureBox5.ImageLocation == "καρπούζι.png")
                    {
                    ...
                    else if (pictureBox1.ImageLocation == "βατόμουρο.png" & pictureBox2.ImageLocation == "βατόμουρο.png" & pictureBox3.ImageLocation == "βατόμουρο.png" & pictureBox4.ImageLocation == "βατόμουρο.png" & pictureBox5.ImageLocation == "βατόμουρο.png")
                    {
                    ...
                    else if (pictureBox1.ImageLocation == "αχλάδι.png" & pictureBox2.ImageLocation == "αχλάδι.png" & pictureBox3.ImageLocation == "αχλάδι.png" & pictureBox4.ImageLocation == "αχλάδι.png" & pictureBox5.ImageLocation == "αχλάδι.png")
                    {
                    ...
                    else if (pictureBox1.ImageLocation == "πορτοκάλι.png" & pictureBox2.ImageLocation == "πορτοκάλι.png" & pictureBox3.ImageLocation == "πορτοκάλι.png" & pictureBox4.ImageLocation == "πορτοκάλι.png" & pictureBox5.ImageLocation == "πορτοκάλι.png")
                    {
                    ...
                    else if (pictureBox1.ImageLocation == "λεμόνι.png" & pictureBox2.ImageLocation == "λεμόνι.png" & pictureBox3.ImageLocation == "λεμόνι.png" & pictureBox4.ImageLocation == "λεμόνι.png" & pictureBox5.ImageLocation == "λεμόνι.png")
                    {
                    ...
                    else if (pictureBox1.ImageLocation == "εφτά.png" & pictureBox2.ImageLocation == "εφτά.png" & pictureBox3.ImageLocation == "εφτά.png" & pictureBox4.ImageLocation == "εφτά.png" & pictureBox5.ImageLocation == "εφτά.png")
                    {
                        MessageBox.Show("Κέρδισες 10 πόντους!!!");
                        coins = coins + 10;
                        label2.Text = coins.ToString();

                        
                    }
                    else if (pictureBox1.ImageLocation == "κεράσι.png" & pictureBox2.ImageLocation == "κεράσι.png" & pictureBox3.ImageLocation == "κεράσι.png" & pictureBox4.ImageLocation == "κεράσι.png" & pictureBox5.ImageLocation == "κεράσι.png")
                    {
                        MessageBox.Show("Κέρδισες 7 πόντους!!!");
                        coins = coins + 7;
                        label2.Text = coins.ToString();
        ...
        {
            //ανοιγω την φορμα 2 ενω πριν στελνω σε αυτη τα coins που υπαρχουν ηδη στην φορμα 4
        ...
        {
            //ανοιγω την φορμα 3 ενω πριν στελνω σε αυτη τα coins που υπαρχουν ηδη στην φορμα 4
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            {
                pictureBox1.ImageLocation = "κεράσι.png";

            }
            else if (froutou == 8)
            {
                pictureBox1.ImageLocation = "εφτά.png";
